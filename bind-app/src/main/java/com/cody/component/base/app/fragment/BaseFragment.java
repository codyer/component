...
import com.cody.component.base.R;
import com.cody.component.base.handler.IView;
import com.cody.component.base.app.ViewAction;
import com.cody.component.base.handler.BaseViewModel;
import com.cody.component.base.handler.IViewModel;
...
public abstract class BaseFragment extends Fragment implements IView {
    ...
    public void showLoading(String message) {
        ...
        mLoading.setTitle(TextUtils.isEmpty(message) ? getString(R.string.loading) : message);
        mLoading.show();
    }

/*
 * ************************************************************
 * 文件：BGASwipeBackHelper.java  模块：app-core  项目：component
...
public class BGASwipeBackHelper {
    ...
    public static void executeForwardAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.ani_forward_enter, R.anim.ani_forward_exit);
    }
    ...
    public static void executeBackwardAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.ani_backward_enter, R.anim.ani_backward_exit);
    }
    ...
    public static void executeSwipeBackAnim(Activity activity) {
        activity.overridePendingTransition(R.anim.ani_swipeback_enter, R.anim.ani_swipeback_exit);
    }

 ...
 * 一个页面只绑定一个viewModel
 */
public abstract class SingleBindFragment<B extends ViewDataBinding, VM extends SingleViewModel<VD>, VD extends FriendlyViewData> extends FriendlyBindFragment<B, VM, VD> {
